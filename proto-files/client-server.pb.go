...
func (*SayHelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c30573352ab90d1c, []int{0}
}
...
func (*SayHelloResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c30573352ab90d1c, []int{1}
}
...
func init() {
	proto.RegisterType((*SayHelloRequest)(nil), "clientServer.SayHelloRequest")
	proto.RegisterType((*SayHelloResponse)(nil), "clientServer.SayHelloResponse")
}

func init() {
	proto.RegisterFile("client-server.proto", fileDescriptor_c30573352ab90d1c)
}

var fileDescriptor_c30573352ab90d1c = []byte{
	// 156 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *sayHelloServiceClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/clientServer.SayHelloService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SayHelloService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clientServer.SayHelloService/SayHello",
	}
...
var _SayHelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "clientServer.SayHelloService",
